...
Research Interests: [Correspondences](https://www.cs.ubc.ca/~lowe/keypoints/), [Vision for Animation](https://en.wikipedia.org/wiki/Twelve_basic_principles_of_animation) and [Open Problems](https://en.wikipedia.org/wiki/List_of_unsolved_problems_in_computer_science).
...
<div class="misc-showcase">
  <p>Favorite manga fanbook(s): <a class="hover-photo hover-photo--manga" href="https://www.pixiv.net/artworks/37362275" target="_blank" rel="noopener noreferrer">Nostalgic Ocean Landscape<span class="hover-photo__card" aria-hidden="true"><img src="/images/nol_preview.png" alt=""></span></a>, <a class="hover-photo hover-photo--manga" href="https://www.pixiv.net/artworks/37362275" target="_blank" rel="noopener noreferrer">Phantom Walk at Night<span class="hover-photo__card" aria-hidden="true"><img src="https://pbs.twimg.com/media/G7DFfZzbgAAZ8DN?format=jpg&name=4096x4096" alt=""></span></a>.</p>
